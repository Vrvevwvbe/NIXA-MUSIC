...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        photo=f"{START_PIC}",
        caption=f"""**اهلآ بك 
في اقوا بوت متطور لتشغيل الاغاني في المكالمات.
الصوتيه لمعرفة اوامر هذا البوت اتبع الأزرار في الاسفل..
**""",
    reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "الاوامر الاساسيه", url=f"https://t.me/Demon_Creators/184"
                    ),
                    InlineKeyboardButton(
